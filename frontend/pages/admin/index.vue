        ...
        <div class="kpi-list">
          ...
          <template v-else-if="stats?.active_events.items.length">
            <div
              ...
              class="kpi-list-item"
              :class="{
                'kpi-list-item--bordered':
                  i < Math.min(stats.active_events.items.length, 5) - 1,
              }"
            >
              {{ ev.eventName }}
            </div>
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-past-table">
          ...
          <template v-else-if="stats?.completed_events.items.length">
            ...
            <div
              v-for="ev in stats.completed_events.items.slice(0, 4)"
              :key="ev.id_event"
              class="kpi-past-row"
            >
...
.kpi-past-row:last-of-type {
  border-bottom: none;
}
.kpi-past-row span:first-child {
  font-size: 0.82rem;
  color: var(--text-secondary);
  white-space: nowrap;
  overflow: hidden;
