<template>
  <div class="auth-shell">
    <div class="auth-card">
      ...
      <div class="auth-form">
        <div class="field">
          <label class="field-label">Nombre completo <span class="field-required">*</span></label>
          <input
            v-model="form.name"
            type="text"
        ...
        <div class="field">
          <label class="field-label">Confirmar contraseña <span class="field-required">*</span></label>
          <div class="field-password-wrap">
            <input
